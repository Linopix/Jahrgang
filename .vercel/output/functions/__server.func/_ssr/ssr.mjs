...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CJDbLE_S.mjs");
...
var manifest = { "2df0dfe1a846dc2f28b2c6729c76fc68d60aa6292ba063e0c489c46c7bfbaf2b": {
	functionName: "resolvePreviews_createServerFn_handler",
	importer: () => import("./preview-B_SoGMvR.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-vX7p_gv2.mjs").then((n) => n.t),
